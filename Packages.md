...
| fo-dicom.Drawing | [GitHub](https://github.com/fo-dicom/fo-dicom) | [4.0.7](https://www.nuget.org/packages/fo-dicom.Drawing/4.0.7) | [MS-PL](https://opensource.org/licenses/MS-PL)| Support library for reading DICOM pixel data |
...
| Magick.NET-Q16-AnyCPU | [GitHub](https://github.com/dlemstra/Magick.NET) | [9.0.0](https://www.nuget.org/packages/Magick.NET-Q16-AnyCPU/9.0.0) | [Apache License v2](https://github.com/dlemstra/Magick.NET/blob/master/License.txt) | The .NET library for [ImageMagick](https://imagemagick.org/index.php) |
| Microsoft.Extensions.Caching.Memory | [GitHub](https://github.com/dotnet/extensions) | [6.0.0 ](https://www.nuget.org/packages/Microsoft.Extensions.Caching.Memory/6.0.0) | [Apache 2.0](https://www.nuget.org/packages/Microsoft.Extensions.Caching.Memory/3.1.7/License) | Caching the results of evaluations already run to prevent constantly revalidating the same value(s) |
| System.IO.Abstractions | [GitHub](https://github.com/System-IO-Abstractions/System.IO.Abstractions) | [16.1.4](https://www.nuget.org/packages/System.IO.Abstractions/16.1.4) | [MIT](https://opensource.org/licenses/MIT) | Makes file system injectable in tests |
